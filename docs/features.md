...
*   **Multi-Platform Access**: Chat through a web UI (Gradio) or directly via a Telegram bot, which automatically registers its available commands (e.g., `/start`, `/pair`, `/clear`, `/tts`) for easy discovery.
