...
class ComfyUIMusicGenerationProvider(MusicGenerationProvider):
    """Music generation using a local ComfyUI instance (e.g. AudioLDM)."""
    ...
    def generate(self, prompt: str) -> str:
        ...
        # 5. Fetch the resulting audio from /view
        return (
            f"ComfyUI music generation requested for prompt: '{prompt}'. "
